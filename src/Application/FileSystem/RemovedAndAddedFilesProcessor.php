...
final class RemovedAndAddedFilesProcessor
{
    ...
    {
        foreach ($this->removedAndAddedFilesCollector->getRemovedFiles() as $removedFiles) {
            $relativePath = $removedFiles->getRelativeFilePathFromDirectory(getcwd());
            ...
            if ($this->configuration->isDryRun()) {
                ...
                $this->symfonyStyle->warning($message);
                $this->filesystem->remove($removedFiles->getRealPath());
            }
        }
    }
